...
def dict_to_tf_example(data,
  ...
  print(data['filename'])
  print(data['path'].rsplit('.',2)[1])
  #print('file extension')

  #filenames_, file_extension = os.splitext(data['path'])
  #print('path ' + data['path'])
  #print(file_extension)
  #print('files name   '+filenames_)
                                                   
  #print('image directory' + image_subdirectory)                                                 
